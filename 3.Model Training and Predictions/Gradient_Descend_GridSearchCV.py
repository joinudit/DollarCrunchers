...
X_norm = pd.DataFrame(X_norm, columns = final_features)
...
pickle.dump(clf, open("SGD.model", 'wb'))
...
print "Test SSE: " + str(np.sum((prediction.as_matrix() - Y_test.as_matrix()) ** 2))
